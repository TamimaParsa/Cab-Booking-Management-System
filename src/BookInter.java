...
public BookInter(String customerName) {
    ...
    // Attach event listener to txtPrice
...
private void loadSourceComboBox() { 
    try (Connection con = ConnectionProvider.getCon()) {
        ...
        ResultSet rs = st.executeQuery("SELECT DISTINCT source FROM intercitydriver");
    ...
    private void loadDestinationComboBox(String selectedSource) {
         try (Connection con = ConnectionProvider.getCon();
             PreparedStatement ps = con.prepareStatement("SELECT DISTINCT destination FROM intercitydriver WHERE source = ?")) {
   ...
   private void loadDriverComboBox(String selectedSource, String selectedDestination) {
        try (Connection con = ConnectionProvider.getCon();
             PreparedStatement ps = con.prepareStatement("SELECT DISTINCT drivername FROM intercitydriver WHERE source = ? AND destination = ?")) {
            ps.setString(1, selectedSource);
     ...
     private void loadCarAndPrice(String selectedDriver) {
        try (Connection con = ConnectionProvider.getCon();
             PreparedStatement ps = con.prepareStatement("SELECT car, price FROM intercitydriver WHERE drivername = ?")) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtCar, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 388, 216, -1));

        txtPrice.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 432, 216, -1));
        ...
        getContentPane().add(cmbSource, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 246, 216, -1));
        ...
        getContentPane().add(cmbDestination, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 295, 216, -1));
        ...
        getContentPane().add(cmbDriver, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 342, 216, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(102, 121, -1, -1));

        jLabel3.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Source");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(106, 247, -1, -1));

        jLabel4.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Destination");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(68, 296, -1, -1));

        jLabel5.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Driver Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 343, -1, -1));

        jLabel6.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Car");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 395, -1, -1));

        jLabel7.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Price");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 439, -1, -1));
        ...
        getContentPane().add(btnBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 620, 105, 39));
        ...
        getContentPane().add(btnCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 620, 93, 39));
        ...
        getContentPane().add(lblBookingId, new org.netbeans.lib.awtextra.AbsoluteConstraints(244, 123, 220, -1));

        jLabel9.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Date of Booking");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 169, -1, -1));
        getContentPane().add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 514, 216, 67));

        jLabel10.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Address");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 540, -1, -1));
        getContentPane().add(txtAdvancePayment, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 473, 216, -1));

        jLabel12.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText(" Advance (10%)");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(53, 477, -1, -1));
        getContentPane().add(txtdoBooking, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 166, 220, -1));

        jLabel8.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Time of Booking");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 207, -1, -1));
        ...
        getContentPane().add(cmbTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 206, 150, -1));

        cmbAmPm.setFont(new java.awt.Font("Showcard Gothic", 0, 12)); // NOI18N
        cmbAmPm.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbAmPmActionPerformed(evt);
            }
        });
        getContentPane().add(cmbAmPm, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 206, 58, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/blue900x900.jpg"))); // NOI18N
        jLabel11.setText("jLabel11");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 690));
...
String insertQuery = "INSERT INTO interBooking (booking_id, userName, doBooking, time, ampm, source, destination, driver_name, car, price, advance_payment, cash_on_delivery, address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
try (Connection con = ConnectionProvider.getCon();
    ...
    private void cmbAmPmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbAmPmActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbAmPmActionPerformed
    ...
    public static void main(String args[]) {
        ...
        public void run() {
            new BookInter("Test User").setVisible(true); // Test with a sample name
        }
    });
    }
